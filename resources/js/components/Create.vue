    ...
    <v-layout class="justify-center">
        <v-card class="elevation-12 mt-8 mb-12">
            <v-form @submit.prevent="create">
                <v-card-title class="headline font-weight-regular blue-grey white--text">Ask Question</v-card-title>
                <v-card-text>
                    <v-row>
                        <v-col cols="12">
                  ...
                  errors.name[0]
                    ...
                    <v-autocomplete :items="categories" label="Category" v-model="form.category_id" item-text="name" item-value="id"></v-autocomplete>
                    <markdown-editor class="mt-8" :options="options" v-model="form.body"></markdown-editor>
                </v-card-text>
